...
# -----------------------------
# Example Usage (Assuming You Already Have x_train, y_train, x_test, y_test)
# -----------------------------
# Make sure x_train, y_train, x_test, y_test are PyTorch tensors for plain model
# and numpy arrays for encrypted model (x_train.numpy(), etc.)
